    ...
    while True:
        ...
        if message["type"] == "close":
            ...
            if message["symbol"] == "XLF": 
                ...
                if (3 * (1000) + 2 * portfolio['GS'] + 3 * portfolio['MS'] + 2 * portfolio['WFC'] - 2) > xlf_ask_price:
                    exchange.send_add_message(order_id=9, symbol="XLF", dir=Dir.BUY, price=xlf_ask_price, size=1)
                    portfolio["XLF"] += 1
                elif (3 * (1000) + 2 * portfolio['GS'] + 3 * portfolio['MS'] + 2 * portfolio['WFC'] + 2) < xlf_ask_price:
                    exchange.send_add_message(order_id=9, symbol="XLF", dir=Dir.SELL, price=xlf_ask_price, size=1)
                    portfolio["XLF"] -= 1
